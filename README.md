This App is a real-time flight tracker. Also, it allows you to put SQL-like commands to retrive/change flight data. Moreover, it can generate logs and reports (about state of entities).
